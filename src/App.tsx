    ...
    <div className="animate-fade-in">
      <section className="relative min-h-[90vh] flex items-center justify-center px-8 pt-20 overflow-hidden">
        ...
        <div className="container mx-auto relative z-10 flex flex-col items-center">
          <div className="relative w-full text-center z-20 md:z-0 mt-12 md:mt-20">
            <h1 className="flex flex-col items-center justify-center text-[7.5vw] md:text-[6.5vw] font-syne font-black leading-[0.85] tracking-tighter uppercase select-none w-full whitespace-nowrap overflow-visible">
              <span className="text-on-surface reveal-on-scroll reveal-delay-100 relative md:-z-10">AARYAN</span>
              <span className="text-stroke reveal-on-scroll reveal-delay-200 relative md:-z-10">NAMPOOTHIRI</span>
            </h1>
          </div>
          <div className="absolute inset-x-0 top-0 md:bottom-0 flex items-start md:items-center justify-center z-10 pointer-events-none reveal-on-scroll pt-24 md:pt-16">
          ...
          <div className="relative z-20 mt-[55vh] md:mt-56 w-full flex flex-col md:flex-row items-center justify-between gap-12 px-8 max-w-7xl mx-auto">
